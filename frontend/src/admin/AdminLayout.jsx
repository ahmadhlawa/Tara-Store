...
export default function AdminLayout() {
  ...
  return (
    <div style={sx`direction:rtl;min-height:100vh;background:var(--admin-page-background);display:flex;flex-direction:column`}>
      ...
      <header className="admin-shell-header" inert={menuOpen ? "" : undefined} style={sx`background:#fff;border-bottom:1px solid #E7DCF2;box-shadow:inset 0 -3px 0 -2px var(--admin-secondary);position:sticky;top:0;z-index:60`}>
      ...
      <div className="admin-shell-grid" style={sx`max-width:1400px;width:100%;margin:0 auto;padding:20px;display:grid;grid-template-columns:var(--adminG);gap:20px;align-items:start;flex:1;box-sizing:border-box`}>
