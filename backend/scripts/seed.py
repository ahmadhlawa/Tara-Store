...
PRODUCTS = [
    ...
    ("mold-coaster-rect", "قالب سيليكون كوستر مستطيل سادة", "silicone-molds", ProductType.STANDARD, "10.00", None, 65, "f", "clay"),
    ("mold-heart-frame", "قالب سيليكون إطار صورة شكل قلب", "silicone-molds", ProductType.STANDARD, "15.00", None, 40, "n", "clay"),
    ("mold-cube-10", "قالب سيليكون مكعب شفاف ١٠ سم مع دعامات", "silicone-molds", ProductType.STANDARD, "16.00", "20.00", 28, "fb", "clay"),
    ("mold-lotus-bowl", "قالب سيليكون وعاء زهرة اللوتس", "silicone-molds", ProductType.STANDARD, "6.00", None, 52, "", "clay"),
    ("mold-arabic-letters", "قالب حروف عربية بارزة", "silicone-molds", ProductType.STANDARD, "52.00", "68.00", 11, "", "clay"),
...
STATIC_PAGES = [
    ...
    (
        ...
        "لا يمكن استبدال أو إرجاع المنتجات بعد تأكيد الطلب أو استلامه.",
